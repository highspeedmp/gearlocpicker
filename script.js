...
function getGearlocs(playerCount){
    ...
    var i = 1;
    while (i <= playerCount){
        var loc = document.getElementById('Gearloc' + i);
...
btnPicket.addEventListener('click', (e) => {
    var check = gearlocList.indexOf("Picket");
    if (check != -1){
...
btnPatches.addEventListener('click', (e) => {
    var check = gearlocList.indexOf("Patches");
    if (check != -1){
        gearlocList.splice(check,1)
...
btnTantrum.addEventListener('click', (e) => {
    var check = gearlocList.indexOf("Tantrum");
    if (check != -1){
        gearlocList.splice(check,1)
...
btnBoomer.addEventListener('click', (e) => {
    var check = gearlocList.indexOf("Boomer");
    if (check != -1){
        gearlocList.splice(check,1)
...
btnTink.addEventListener('click', (e) => {
    var check = gearlocList.indexOf("Tink");
    if (check != -1){
        gearlocList.splice(check,1)
...
btnGhille.addEventListener('click', (e) => {
    var check = gearlocList.indexOf("Ghille");
    if (check != -1){
        gearlocList.splice(check,1)
...
btnNugget.addEventListener('click', (e) => {
    var check = gearlocList.indexOf("Nugget");
    if (check != -1){
        gearlocList.splice(check,1)
...
btnStanza.addEventListener('click', (e) => {
    var check = gearlocList.indexOf("Stanza");
    if (check != -1){
        gearlocList.splice(check,1)
...
btnDuster.addEventListener('click', (e) => {
    var check = gearlocList.indexOf("Duster");
    if (check != -1){
        gearlocList.splice(check,1)
...
btnGasket.addEventListener('click', (e) => {
    var check = gearlocList.indexOf("Gasket");
    if (check != -1){
        gearlocList.splice(check,1)
...
btnLabRats.addEventListener('click', (e) => {
    var check = gearlocList.indexOf("Lab Rats");
    if (check != -1){
        gearlocList.splice(check,1)
...
btnDart.addEventListener('click', (e) => {
    var check = gearlocList.indexOf("Dart");
    if (check != -1){
        gearlocList.splice(check,1)
